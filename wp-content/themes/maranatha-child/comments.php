<?php
/**
 * Comments list and form — child override (pinned verbatim copy).
 *
 ...
 * comments.php; it still calls maranatha_loop_after_content_used(),
 * maranatha_get_icon_class() and the ctfw_comment callback from the parent,
 * so behavior is identical for now.
 *
 * Parent source: maranatha/comments.php (pinned in this repo) — re-diff if the
