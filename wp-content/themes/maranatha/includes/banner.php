 ...
 */
function maranatha_banner_related_pages() {
	...
	return apply_filters( 'maranatha_banner_pages', $pages_query->posts );
 ...
 */
function maranatha_banner_data() {
	...
	// Return filtered
	return apply_filters( 'maranatha_banner_data', $data );
