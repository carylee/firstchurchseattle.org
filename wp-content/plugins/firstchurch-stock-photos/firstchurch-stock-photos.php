 ...
 * Description: Find attribution-safe, openly-licensed photos from Openverse and pull them into the media library — from the WP admin (Media ▸ Stock Photos), a tab in the wp.media modal wherever you insert media, or programmatically via the MCP server. Captures provider/creator/license provenance on every import.
 * Version:     0.6.0
